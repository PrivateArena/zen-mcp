...
| internal/tools/pool.go | Pool tool: poll/cancel/status over pooling.Registry | ~121 | `HandlePoolAction(ctx, reg *pooling.Registry, req mcp.CallToolRequest) *mcp.CallToolResult`; `statusPayload(state, id string, reg) map[string]any` |
