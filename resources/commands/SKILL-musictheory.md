---
description: High-performance music analysis, transformation, and structural auditing using the musictheory engine. Supports theoretical scoring (Robotics/Groove), note-by-note diffing, and LilyPond notation export.
argument-hint: |-
  i: Context or specific instructions for this skill
---
# Skill: Music Theory & MIDI Analysis
