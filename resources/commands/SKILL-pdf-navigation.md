---
description: Techniques for navigating and extracting content from PDFs using Firefox's built-in PDF viewer (PDF.js). Focuses on viewing, jumping to pages, and text extraction.
argument-hint: |-
  i: Context or specific instructions for this skill
---
# Skill: PDF Navigation & Extraction
