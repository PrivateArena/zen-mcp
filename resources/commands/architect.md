---
description: Plan and design system architecture with deep expertise, stress-tested via a browser.chat second opinion. No implementation code, no file edits.
argument-hint: |-
  i: What to plan and design
---
