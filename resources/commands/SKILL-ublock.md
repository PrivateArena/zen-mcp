---
description: Expert-level framework for uBlock Origin filter syntax, procedural cosmetic filtering, and advanced scriptlet injections. Provides a 100% authoritative library for web automation, anti-bot bypassing, and precision DOM/Network modification. Use this skill whenever you need to automate web interactions, bypass anti-adblock mechanisms, or optimize network request routing.
argument-hint: |-
  i: Context or specific instructions for this skill
---
# Skill: uBlock Origin Filter Engineering (v0.5)
...
- [static-filtering.md](file:///media/jang/home/Deve/web-reader-mcp-master/src/resources/skills/ublock_kb/static-filtering.md)
- [scriptlets.md](file:///media/jang/home/Deve/web-reader-mcp-master/src/resources/skills/ublock_kb/scriptlets.md)
- [cosmetic.md](file:///media/jang/home/Deve/web-reader-mcp-master/src/resources/skills/ublock_kb/cosmetic.md)
