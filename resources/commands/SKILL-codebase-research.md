---
description: Efficiently map and understand complex codebases using MCP codegraph. Prioritizes local indexing over recursive text searches to maximize token saving.
argument-hint: |-
