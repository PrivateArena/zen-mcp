---
description: Expert guide for analyzing images, screenshots, and visual UIs using multimodal AI providers (Gemini/Google). Use for UI breakdown, text extraction from images, and visual element localization.
argument-hint: |-
  i: Context or specific instructions for this skill
---
# Skill: Visual Analysis & Multimodal UI
