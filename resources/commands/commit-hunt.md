---
description: Isolate, analyze, and resolve a regression or panic introduced in one or more git commits.
argument-hint: |-
  i: The git commit SHA(s), range, or list (e.g. 'd1c98d1c', 'X Y', 'X,Y', 'X..Y') to investigate
  m: The panic error message or stack trace
---
