...
argument-hint: |-
  i: The git commit SHA(s), range, or list (e.g. 'd1c98d1c', 'X Y', 'X,Y', 'X..Y') to diff
  m: Additional notes, context, or GitHub URL related to the review
---
